...
-- Change background
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd('matugen image "$(ls $HOME/.dotfiles/wallpapers | fuzzel -d --width=30 -l 8 | sed "s|^|$HOME/.dotfiles/wallpapers/|")" --prefer=saturation'))
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd('matugen image "$HOME/.dotfiles/wallpapers/bg$(( $(od -An -N4 -tu4 /dev/random) % $(ls -1 $HOME/.dotfiles/wallpapers/bg*.jpg | wc -l) )).jpg" --prefer=saturation'))
