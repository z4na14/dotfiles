...
| nvim — Completion (blink.cmp) | `<leader>es` | Show completion menu / toggle documentation |
| nvim — Completion (blink.cmp) | `<leader>eh` | Hide completion menu |
| nvim — Completion (blink.cmp) | `<leader>ey` | Select and accept current item |
| nvim — Completion (blink.cmp) | `<leader>en` | Select next item |
| nvim — Completion (blink.cmp) | `<leader>ep` | Select previous item |
| nvim — Completion (blink.cmp) | `<leader>ef` | Jump forward in snippet |
| nvim — Completion (blink.cmp) | `<leader>eb` | Jump backward in snippet |
| nvim — Completion (blink.cmp) | `<leader>eu` | Scroll documentation up |
| nvim — Completion (blink.cmp) | `<leader>ed` | Scroll documentation down |
